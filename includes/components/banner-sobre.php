...
<div class="Banner">
    ...
    <div class="swiper mySwiper" data-swiper-config='{
        "slidesPerView": 1,
        "pagination": {"el": ".banner-sobre-pagination", "clickable": true, "type": "bullets"},
        "autoplay": {"delay": 4000},
        "loop": false,
                        ...
                        <picture>
                            ...
                            <?php if (!empty($banner['desktop'])): ?>
                                <img src="<?php echo htmlspecialchars($banner['desktop']); ?>" 
                                     alt="<?php echo htmlspecialchars($banner['titulo'] ?? 'Banner Sobre Brasil Center'); ?>" 
                                     aria-hidden="true">
                            <?php endif; ?>
                        </picture>
        ...
        <div class="swiper-pagination banner-sobre-pagination"></div>
    </div>
</div>
<?php endif; ?>
